...
function offsetColumnSize(column, width, min, max) {
  ...
  return (0, _clamp.default)(Math.round(width - ((_column$growOffset = column.growOffset) !== null && _column$growOffset !== void 0 ? _column$growOffset : 0)), Math.ceil(min), Math.floor(max));
}
